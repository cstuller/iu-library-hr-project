<?php
/**
 * Contains the function calls to create the position approval edit confirmation
 * page for the HR portal.
 *
 ...
 */
 ...
 elseif(!empty($errorList)) {
   $page .= buildHRApproveEditPage($errorList);
 }
 // Otherwise, show the job confirmation page
 else{
   $page .= buildHRApproveEditConfirm();
 }
